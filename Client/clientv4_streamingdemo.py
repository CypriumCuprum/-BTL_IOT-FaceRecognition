...
HOST_BE = "http://192.168.43.32:5000/"
...
class FaceRecognitionClient:
    def __init__(self, aiapi_url="http://192.168.43.32:8000", host_be=HOST_BE, stream_port=8765):
    ...
    def run(self):
        ...
        try:
            while True:
                ...
                try:
                    frame_data = {
                        'image': self.encode_image_base64(frame),
